...
$to = $_GET["to"];
$query = mysqli_query($conn, "SELECT * FROM article WHERE category = '$to' ");
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="worldNav">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="index.html#articlePage">Article</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="index.html#disclaimerPage">Disclaimer</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="tab-pane fade show active" id="world-tab-1" role="tabpanel" aria-labelledby="tab1">
                                    ...
                                    <?php while($row = mysqli_fetch_assoc($query)) : ?>
                                        ...
                                        <div class="post-content">
                                            <a href="single-blog.php?to=<?= $row["id"] ?>" class="headline">
                                                <h5><?= $row["title"] ?></h5>
                                            </a>
                                            <p><?= substr($row["text"],0,100) ?> ...</p>
                                            <!-- Post Meta -->
                                            <div class="post-meta">
                                                <p><a href="#" class="post-author"><?= $row["author"] ?></a> on <a href="#" class="post-date"><?= $row["date"] ?></a></p>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endwhile; ?>
                    ...
                    <div class="post-sidebar-area">
                        ...
                        <div class="sidebar-widget-area">
                            ...
                            <div class="widget-content">
                                <div style="width: 250px; height: 360px;margin-bottom: 20px;overflow: hidden;">
                                    <img src="<?= $aboutList["nama_gambar"]?>" alt="" style="width: 100%;">
                                </div>
                                <p style="text-align: justify;"><?= $aboutList["profile"] ?></p>
                            </div>
                        </div>
                        <!-- Widget Area -->
                        <div class="sidebar-widget-area">
