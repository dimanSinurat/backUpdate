            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="single-blog-title text-center">
                        <!-- Catagory -->
                        <div class="post-cta"><a href="#"><?php echo $row["category"] ?></a></div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8">
                    <div class="single-blog-content mb-100">
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <p><a href="#" class="post-author"><?php echo $row["author"] ?></a> on <a href="#" class="post-date"><?php echo $row["date"] ?></a></p>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                        <h6 style="text-align:justify; text-indent:60px" ><?php echo $row["text"] ?></h6>
                            <!-- Post Tags -->
                            <ul class="post-tags">
